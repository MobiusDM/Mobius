...
// the github.com/notawar/mobius/backend/server/vulnerabilities/nvd/tools doesn't yet support parsing
...
func (s *CVE) updateYearFile(year int, cves []nvdapi.CVEItem) error {
	...
	// This is assumed by the github.com/notawar/mobius/backend/server/vulnerabilities/nvd/tools package.
	if year < 2002 {
		year = 2002
	}
